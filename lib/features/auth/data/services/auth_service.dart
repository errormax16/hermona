...
class AuthService {
  ...
  Future<UserEntity> login({
    ...
    try {
      ...
      return await fetchUser(cred.user!.uid) ??
          UserEntity(
            id: cred.user!.uid, firstName: '', lastName: '',
            email: email, createdAt: DateTime.now(), termsAccepted: true,
          );
    } on FirebaseAuthException catch (e) {
      throw AuthException(_mapFirebaseError(e.code));
    }
  ...
  Future<UserEntity> signInWithGoogle() async {
    try {
      ...
      if (gUser == null) throw const AuthException('Connexion Google annulée');
